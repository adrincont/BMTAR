...
# estruc2 = mtarstr(ini_obj = initial,niter = 5000,chain = TRUE,burn = 1000,r_init = 2.6)
# autoplot.regime_model(estruc2,4)
#estruc2$orders
```
...
# autoplot.regime_forecast(pred1,1)
# autoplot.regime_forecast(pred1,2)
```
