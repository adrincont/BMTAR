...
Finalmente vemos la estimación de los parámetros con valor de umbral estimado final de 2.54 y en el gráfico el ajuste del modelo a la serie de datos una vez completados los valores faltantes.
