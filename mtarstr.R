...
# Function:
mtarstr = function(Yt, Ut = NULL, l, orders, level = 0.95, method= c('KUO','SSVS')[1], niter, burn = NULL,
...
# Metodo KUO
estruc = mtarstr(Yt = yt$Yt,Ut = Ut,l = 2,orders = list(pjmax = c(2,2),qjmax = c(1,1),djmax = c(1,1)),niter = 100,method = 'KUO',chain = T)
forecast::autoplot(ts(t(estruc$Chain$r$R1)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$r$R2)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$Theta$R1)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$Theta$R2)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$Sigma$R1)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$Sigma$R2)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$gamma$R1)),facets = TRUE)
forecast::autoplot(ts(t(estruc$Chain$gamma$R2)),facets = TRUE)
estruc$tasar
estruc$r
estruc$Regim
# Metodo SSVS
estruc2 = mtarstr(Yt = yt$Yt,Ut = Ut,l = 2,orders = list(pjmax = c(2,2),qjmax = c(1,1),djmax = c(1,1)),niter = 200,method = 'SSVS',chain = T)
estruc2$tasar
estruc2$r
estruc2$Regim
